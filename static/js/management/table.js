function showtable(){
    ...
    for(i=0;i<infor_length;i++){
        ...
        document.writeln("<a href=\"profile" + "/" + obj[i].account + "\"" + " class=\"avatar avatar-sm mr-2\"><img class=\"avatar-img rounded-circle\" src=\"static/assets/img/profiles/" + obj[i].account +".jpg\" alt=\"User Image\"></a>")
        document.writeln("<a id=\"name_"+i+"\" href=\"profile" + "/" + obj[i].account + "\"" +">"+obj[i].name+"</a>")
        document.writeln("</h2>")
        document.writeln("</td>")
        if(obj[i].authorityLevel == 2)
