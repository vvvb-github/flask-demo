// HPC热力图
let Chart_hum = echarts.init(document.getElementById('echarts-hum'));
// TPC热力图
let Chart_tem = echarts.init(document.getElementById('echarts-tem'));
...
Chart_hum.setOption(option3)
Chart_tem.setOption(option3)